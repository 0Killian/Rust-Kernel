...
"C:/Program Files/qemu/qemu-system-x86_64" -machine q35 -drive file=target/x86_64-os/debug/boot-uefi-rust-kernel.img -m 256M -cpu qemu64 -drive if=pflash,format=raw,unit=0,file="C:/Program Files/qemu/share/edk2-x86_64-code.fd",readonly=on -drive if=pflash,format=raw,unit=1,file="C:/Program Files/qemu/share/edk2-i386-vars.fd" -net none -serial stdio
